"""Train DNN (regular/TRADES/VAT) with PyTorch."""
import torch
...
from src.utils import boolean_string, pytorch_evaluate, get_image_shape, set_logger
...
parser.add_argument('--net', default='resnet34', type=str, help='network architecture: resnet34/resnet50/resnet101')
parser.add_argument('--activation', default='relu', type=str, help='network activation: relu or softplus')
parser.add_argument('--checkpoint_dir', default='/tmp/adversarial_robustness/cifar10/resnet34/regular_resnet34_00', type=str, help='checkpoint dir')
