...
from src.datasets.my_cifar10 import MyCIFAR10
from src.datasets.my_cifar100 import MyCIFAR100
from src.datasets.my_svhn import MySVHN
from src.datasets.tiny_imagenet import TinyImageNet
...
def get_test_loader(dataset,
    ...
    - pin_memory: whether to copy tensors into CUDA pinned memory. Set it to
      True if using GPU.
    - transforms: input image transforms
    Returns
    -------
